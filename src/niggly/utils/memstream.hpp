...
/**
 * @ingroup niggly-io
 * @brief A `std::basic_ostream` around a block of memory.
 *        Analogous to `fmemopen`.
 */
...
class basic_omemstream : public std::basic_ostream<CharT, Traits>
{
 ...
 public:
   ...
   friend void swap(basic_omemstream<CharT, Traits, Allocator>& lhs,
                    basic_omemstream<CharT, Traits, Allocator>& rhs)
   {
      lhs.swap(rhs);
   }
};
...
/**
 * @ingroup niggly-io
 * @brief A `std::basic_istream` that writes to a block of memory.
 *        Analogous to `fmemopen`.
 */
template<class CharT,
         class Traits    = std::char_traits<CharT>,
...
class basic_imemstream : public std::basic_istream<CharT, Traits>
{
 ...
 public:
   ...
   friend void swap(basic_imemstream<CharT, Traits, Allocator>& lhs,
                    basic_imemstream<CharT, Traits, Allocator>& rhs)
   {
      lhs.swap(rhs);
   }
};
...
/**
 * @ingroup niggly-io
 * @brief A `std::basic_iostream` that read/writes to a block of memory.
 *        Analogous to `fmemopen`.
 */
template<class CharT,
         class Traits    = std::char_traits<CharT>,
...
class basic_memstream : public std::basic_iostream<CharT, Traits>
{
 ...
 public:
   ...
   friend void swap(basic_memstream<CharT, Traits, Allocator>& lhs,
                    basic_memstream<CharT, Traits, Allocator>& rhs)
   {
      lhs.swap(rhs);
   }
};
